...
// let username = "abdalla boss";
// let products =["bur","bariis","saliid","qudaar"];
// let bloggs =["abdullahi waa wiil mashquul badan",
//               "axmed waa wiil gaari leh",
//               "daahir waxa uu sameeyey dayax kacmeed",
//               "suleyqo waa gabar dowladda ushaqeyso",
//             ];

// //create products container to add the products dynamically
...
// // // ✅ Route Handler
// // app.get('/', (req, res) => {
// //   res.send(`Hello! This request was made at: ${new Date(req.requestTime).toISOString()}`);
// // });
...
//     // console.log("user1:", login.users.abdalla.name)
// })
